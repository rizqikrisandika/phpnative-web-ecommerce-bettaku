            ...
            <div class="main-content-inner">
                <div class="row">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Purchase</h4>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <tbody>
                                        <?php 
                                            $db = mysqli_query($koneksi,"select * from pembelian join pelanggan on pembelian.id_pelanggan=pelanggan.id_pelanggan");                                               
                                            $mulai = 0;
                                            $no =$mulai+1;
                                            
                                            while ($pembelian = mysqli_fetch_assoc($db)) { ?>
                                                <tr>
                                                    <td><?php echo $no++ ?></td>
