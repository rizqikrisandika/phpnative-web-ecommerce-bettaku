<?php 
    ...
    if(!isset($_SESSION['admin']))
    {
        ...
        echo "<script>location='index.php?admin=login-admin'</script>";
        header('location:index.php?admin=login-admin');
        exit();
    }
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="index.php?page=dashboard1">ICO dashboard</a></li>
                                    <li><a href="index.php?page=dashboard2">Ecommerce dashboard</a></li>
                                    <li><a href="index.php?page=dashboard3">SEO dashboard</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php?page=dashboard1">Home</a></li>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['admin'] ?><i class="fa fa-angle-down"></i></h4>
