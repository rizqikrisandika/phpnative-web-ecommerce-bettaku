		...
		<div class="container">
			<div class="row">
						...
						<div class="sidebar-box-2">
							...
							<div class="fancy-collapse-panel">
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item"><a href="index.php?bettaku=home" class="nav-link">Halfmoon</a>
									</li>
									<li class="nav-item"><a href="index.php?bettaku=home" class="nav-link">Slayer</a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="col-md-8 col-lg-10 order-md-last">
					<div class="row">
						<?php $db = mysqli_query($koneksi,"SELECT * from produk join kategori on produk.id_kategori=kategori.id_kategori order by produk.tanggal_produk desc");?>
