    ...
    <section class="ftco-section ftco-cart">
    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="cart-list">
	    				<table class="table">
							...
							?>
						      <tr class="text-center">
						        <td class="product-remove"><a href="index.php?bettaku=deletecart&id=<?php echo $id_produk ?>"><span class="ion-ios-close"></span></a></td>
						        <td>
						        	<?php echo $no++?>
						        </td>
						        ...
						        <td class="quantity">
						        	<div class="input-group mb-3">
					             	<input type="text" name="quantity" class="quantity form-control input-number" disabled value="<?php echo $jumlah ?>">
					          	</div>
					          </td>
    		...
    		<div class="row justify-content-start">
    			<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
    				...
    				<p class="text-center"><a href="index.php?bettaku=checkout" class="btn btn-primary py-3 px-4">Proceed to Checkout</a></p>
    			</div>
    		</div>
			</div>
		</section>
