				...
				<h3 class="mb-4 billing-heading">Billing Details</h3>
				  ...
				  <div class="col-md-6">
		            ...
		            <div class="col-md-12">
	                  ...
	                  <textarea class="form-control" name="" id="" cols="30" rows="10"><?php echo $data['alamat_pelanggan']; ?></textarea>
	                </div>
		            </div>
					...
					<p class="text-center"><button name="checkout" class="btn btn-primary py-3 px-4">Proceed to Checkout</button></p>	
    			</div>
