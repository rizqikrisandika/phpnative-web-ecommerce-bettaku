	    ...
	    <div class="container">
		  ...
		  <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item"><a href="index.php?bettaku=faq" class="nav-link">Faq</a></li>
                ...
                <?php else: ?>
					<li class="nav-item"><a href="index.php?bettakuu=login-user" class="nav-link btn-login">Login</a></li>
                <?php endif ?>
	          <li class="nav-item cta cta-colored"><a href="index.php?bettaku=cart" class="nav-link"><span class="icon-shopping_cart"></span></a></li>
             ...
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="d-flex">
	              <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
	                <li><a href="index.php?bettaku=ongkir" class="py-2 d-block">Shipping Information</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Jl. Ring Road Utara, Condong Catur, Sleman, Yogyakarta - Indonesia.</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+62 89523269898</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">bettaku.id@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
